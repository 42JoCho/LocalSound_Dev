...
<head>
    ...
    <link rel="stylesheet" href="detailUI.css">
    ...
    <script type="text/javascript">
        ...
        function selectOnChange() {
            ...
            var dongOption = {
                ...
                namgu: ['이천동', '봉덕동', '대명동'],
                soosunggu: ['범어동', '만촌동', '수성가동', '황금동', '중동', '상동', '파동', '두산동', '지산동', '범물동', '고산동'],
                dalseogu: ['성당동', '두류동', '본리동', '감삼동', '죽전동', '장기동', '용산동', '이곡동', '신당동', '월성동', '진천동', '상인동', '도원동', '송현동', '본동'],
                dalsunggoon: ['화원읍', '논공읍', '다사읍', '유가읍', '옥포읍', '현풍읍', '가창면', '하빈면', '구지면']
            }
...
<div class="write">
    <form action="main.jsp" method="post">
        ...
        <tr>
            <p class="title">
                <input class="detailtitle" type="text" name="title"
                       placeholder="제목을 입력하세요" size="60"/>
            </p>
        </tr>
        <tr>
            <p class="detail">
        ...
        <p class="detailcontent">
				<textarea class="detailcontent" name="detailcontent"
                          placeholder="내용을 입력하세요" cols="40" rows="10"></textarea>
        </p>
        <p>
